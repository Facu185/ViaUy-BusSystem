...
try {
    if (!empty($_POST["addRoute"])) {
        ...
        if(!filter_var($id_linea, FILTER_VALIDATE_INT)){
            echo '<script>alert("La linea solo puede contener numeros"); window.location.href = "./addNewRoutePage"; </script>';
            exit;
        }
        if(!filter_var($tramo_anterior, FILTER_VALIDATE_INT)){
            echo '<script>alert("El tramo anterior solo puede contener numeros"); window.location.href = "./addNewRoutePage"; </script>';
            exit;
        }
        if(!filter_var($tramo_agregar, FILTER_VALIDATE_INT)){
            echo '<script>alert("El tramo a agregar solo puede contener numeros"); window.location.href = "./addNewRoutePage"; </script>';
            exit;
        }
